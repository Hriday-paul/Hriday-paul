                ...
                <div className="py-20 2xl:max-w-7xl max-w-6xl mx-auto px-4">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-x-5 md:gap-y-0 mt-10'>
                        ...
                        <div className='space-y-5' data-aos="zoom-in-up">
                            ...
                            <p className='text-gray-300 text-base'>{"I'm currently available to take on new projects, so feel free to send ma a message about anything that you want me to work on. You can contact anytime."}</p>
                            <div className='flex flex-row gap-x-4 items-center'>
                                <MdOutlineEmail className='text-2xl text-white' />
                                <h3 className='text-base text-gray-200 font-medium font-popins' >hridoychandrapaul.10@gmail.com</h3>
                            </div>
                            <div className='flex flex-row gap-x-4 items-center'>
                                <MdPhoneInTalk className='text-2xl text-white' />
                                <h3 className='text-base text-gray-200 font-medium font-popins' >+8801892814892</h3>
                            </div>
                            <div className='flex flex-row gap-x-4 items-center'>
                        ...
                        <form data-aos="zoom-in-up" action="#" className="space-y-5" onSubmit={handleContact}>
                            <div>
                                ...
                                <input type="email" id="email" name='email' className="shadow-sm border text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" placeholder="xyz@gmail.com" required />
                            </div>
                            <div>
                                <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-300">Subject</label>
                                <input type="text" id="subject" name="subject" className="shadow-sm border text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" placeholder="subject..." required />
                            </div>
                            <div className="sm:col-span-2">
                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-300">Your message</label>
                                <textarea id="message" name="message" rows="6" className="block p-2.5 w-full text-sm  rounded-lg shadow-sm border focus:ring-primary-500 focus:border-primary-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Leave a message..." required></textarea>
                            </div>
